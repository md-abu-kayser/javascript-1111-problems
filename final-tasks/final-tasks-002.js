...
// task-->18
{
  ...
  class TodoApp {
    ...
    async retryTodoOperation(name, asyncFn, maxRetries = 3, baseDelay = 100) {
  ...
  myTodos.addTodo("Upload Project", "Learning", "2 hours");
...
// task-->19
{
  ...
  class TodoApp {
    ...
    createSnapshot() {
      ...
      this.snapshots.set(id, Object.freeze(snapshot));
    ...
    restoreSnapshot(id) {
      ...
      this.todos = structuredClone(this.snapshots.get(id));
  ...
  myTodos.addTodo("Learn TypeScript", "Learning", "4 hours");
...
// task-->20
{
  ...
  class TodoApp {
    ...
    memoizedTodoSearch(query) {
      ...
      const frozenResult = Object.freeze(structuredClone(result));
  ...
  myTodos.addTodo("JavaScript Project", "Learning", "5 hours");

  console.log(myTodos.memoizedTodoSearch("javascript"));
...
// task-->21
{
  ...
  myTodos.addTodo("Study Node.js", "Learning", "3 hours");

  myTodos.addTodo("Build Express API", "Learning", "5 hours");
